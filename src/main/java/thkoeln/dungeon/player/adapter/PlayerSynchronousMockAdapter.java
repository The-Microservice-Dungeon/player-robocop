...
@Component
@Profile( "mock" )
public class PlayerSynchronousMockAdapter implements PlayerSynchronousAdapter {

    private Logger logger = LoggerFactory.getLogger( PlayerSynchronousMockAdapter.class );
